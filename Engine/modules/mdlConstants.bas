...
Global Const c_lngMaxScreenWidth As Long = 1024&
Global Const c_lngMaxScreenHeight As Long = 768&
Global Const c_lngMaxHistoryLength As Long = 31&
Global Const c_lngMaxPictureSlot As Long = 255&
Global Const c_lngMaxHotspot As Long = 127&
...
Global Const c_lngMaxWaypoints As Long = 256&
Global Const c_lngMaxTimers As Long = 32&
Global Const c_lngMaxCPUUsage As Long = 75&
Global Const c_lngMaxEventQueue As Long = 255&
Global Const c_lngMaxTimerUpdates As Long = 20&
Global Const c_lngMaxCharMappings As Long = 255&
