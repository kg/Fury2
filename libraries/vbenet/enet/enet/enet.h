...
/** @defgroup socket ENet socket functions
    ...
    @ingroup private
*/
extern ENET_API ENetSocket enet_socket_create (ENetSocketType, const ENetAddress *);
extern ENET_API ENetSocket enet_socket_accept (ENetSocket, ENetAddress *);
extern ENET_API int        enet_socket_connect (ENetSocket, const ENetAddress *);
extern ENET_API int        enet_socket_send (ENetSocket, const ENetAddress *, const ENetBuffer *, size_t);
extern ENET_API int        enet_socket_receive (ENetSocket, ENetAddress *, ENetBuffer *, size_t);
extern ENET_API int        enet_socket_wait (ENetSocket, enet_uint32 *, enet_uint32);
extern ENET_API void       enet_socket_destroy (ENetSocket);
...
*/
extern ENET_API int enet_address_set_host (ENetAddress *address, const char *hostName );
...
/** Attempts to do a reserve lookup of the host field in the address parameter.
    ...
    @retval < 0 on failure
*/
extern ENET_API int enet_address_get_host (const ENetAddress *address, char *hostName, size_t nameLength );
