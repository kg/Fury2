...
Section "Start Menu Shortcuts"
  ...
  CreateShortCut "$SMPROGRAMS\Fury²\Examples\Distort Example.lnk" "$INSTDIR\sys\fury².exe" "$INSTDIR\examples\distort" "$INSTDIR\sys\fury².exe"
  CreateShortCut "$SMPROGRAMS\Fury²\Examples\EB Example.lnk" "$INSTDIR\sys\fury².exe" "$INSTDIR\examples\eb" "$INSTDIR\sys\fury².exe"
  ...
  CreateShortCut "$SMPROGRAMS\Fury²\Examples\Speech Bubble Example.lnk" "$INSTDIR\sys\fury².exe" "$INSTDIR\examples\speech_bubble" "$INSTDIR\sys\fury².exe"
