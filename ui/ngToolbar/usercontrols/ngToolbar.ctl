...
Private m_btnLastPressed As ngToolButton
...
Dim l_btnNewHover As ngToolButton
    ...
    Else
        ...
        End If
        If Not (m_btnHover Is Nothing) Then Redraw m_btnHover.Rectangle
...
On Error Resume Next
    If Not (m_btnLastPressed Is Nothing) Then
        m_btnLastPressed.MouseDown
        RaiseEvent ButtonClick(m_btnLastPressed)
        m_btnLastPressed.MouseUp
        Set m_btnLastPressed = Nothing
    End If
End Sub
...
Dim l_booCancel As Boolean
    ...
    If Button = 1 Then
        ...
        If m_btnPressed.Enabled Then
            ...
            Set m_btnLastPressed = m_btnPressed
        Else
            Set m_btnPressed = Nothing
        End If
    End If
